...
let video5 = document.createElement('video');
video5.loop = false;
...
let video7 = document.createElement('video');
video7.loop = false;
...
src(o1).layer(src(o0).luma(0.4)).out(o3)
...
// src(o0).layer(src(o2).luma(0.3))
//   .luma(1,0.2)
//   .modulateKaleid(osc(11,0.5,0.5),50)
//   //.roate(voronoi(2,0.5))
//   .colorama(0)
//  // .mult(voronoi(1, 0.5))
//   // .repeat(2, 2)
